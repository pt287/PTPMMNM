...
const translations = {
  vi: {
    ...
    step1Desc: "Tải lên một hoặc nhiều file PDF, DOCX hoặc ảnh để tạo bộ nhớ nội bộ.",
    ...
    pdfLabel: "Chọn file PDF/DOCX/Ảnh",
    ...
    statusNeedPdf: "Vui lòng chọn ít nhất 1 file PDF, DOCX hoặc ảnh.",
  ...
  en: {
    ...
    step1Desc: "Upload one or more PDF, DOCX, or image files to build internal context.",
    ...
    pdfLabel: "Select PDF/DOCX/Image files",
    ...
    statusNeedPdf: "Please upload at least one PDF, DOCX, or image file.",
